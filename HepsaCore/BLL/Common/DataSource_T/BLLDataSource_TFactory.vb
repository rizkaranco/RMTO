...
Namespace BLL
    ...
    Public Class BLLDataSource_TFactory
        Inherits BLL.BusinessFactoryBase

        Private _dataObject As DAL.DALDataSource_T = Nothing

        Public Sub New()
            MyBase.New("DataSource_T")
        ...
        Public Sub Update(ByVal businessObject As BLL.BLLDataSource_T, ByVal businessObjectKey As BLL.BLLDataSource_TKeys)
            Try
                Dim businessObjectEntity As BLL.BLLDataSource_T = Me._dataObject.SelectByPrimaryKey(businessObjectKey)
                If businessObjectEntity IsNot Nothing AndAlso businessObjectEntity.DataSource_nvc.ToLower = businessObject.DataSource_nvc.ToLower Then
        ...
        Public Function GetBy(ByVal keys As BLL.BLLDataSource_TKeys) As BLL.BLLDataSource_T
            Try
        ...
        Public Sub GetBy(ByVal keys As BLL.BLLDataSource_TKeys, ByRef dataSet As System.Data.DataSet, ByVal srcTable As String)
            Try
        ...
        Public Sub GetBy(ByVal keys As BLL.BLLDataSource_TKeys, ByRef dataSet As System.Data.DataSet)
            Try
        ...
        Public Sub GetBy(ByVal keys As BLL.BLLDataSource_TKeys, ByRef dataTable As System.Data.DataTable)
            Try
        ...
        Public Function GetAll() As List(Of BLL.BLLDataSource_T)
            Try
        ...
        Public Function GetAllBy(ByVal fieldName As BLL.BLLDataSource_T.DataSource_TField, ByVal value As Object) As List(Of BLL.BLLDataSource_T)
            Try
        ...
        Public Sub GetAllBy(ByVal fieldName As BLL.BLLDataSource_T.DataSource_TField, ByVal value As Object, ByRef dataSet As System.Data.DataSet, ByVal srcTable As String)
            Try
        ...
        Public Sub GetAllBy(ByVal fieldName As BLL.BLLDataSource_T.DataSource_TField, ByVal value As Object, ByRef dataSet As System.Data.DataSet)
            Try
        ...
        Public Sub GetAllBy(ByVal fieldName As BLL.BLLDataSource_T.DataSource_TField, ByVal value As Object, ByRef dataTable As System.Data.DataTable)
            Try
        ...
        Public Function GetAllByCondition(ByVal Condition As String) As List(Of BLL.BLLDataSource_T)
            Try
        ...
        Public Sub Delete(ByVal keys As BLL.BLLDataSource_TKeys)
            Try
        ...
        Public Sub Delete(ByVal fieldName As BLL.BLLDataSource_T.DataSource_TField, ByVal value As Object)
            Try
