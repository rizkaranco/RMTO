...
{
    public class BLLLadBillCancelComment_TFactory : BusinessFactoryBase
    {
        private HPS.DAL.LadBillCancelCommentDAL.DALLadBillCancelComment_T _dataObject = null;

        public BLLLadBillCancelComment_TFactory()
            : base("LadBillCancelComment_T")
        {
            _dataObject = (HPS.DAL.LadBillCancelCommentDAL.DALLadBillCancelComment_T)base.DataAccessLayer;
        }
        ...
        public void Insert(HPS.BLL.LadBillCancelCommentBLL.BLLLadBillCancelComment_T businessObject)
        {
            try
            {
                if (businessObject.IsValid(Hepsa.Core.Validation.ValidationExceptionType.Except, "LadBillCancelCommentID_int") == false)
                {
        ...
        public void GetBy(HPS.BLL.LadBillCancelCommentBLL.BLLLadBillCancelComment_TKeys keys, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.LadBillCancelCommentBLL.BLLLadBillCancelComment_TKeys keys, ref System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public List<HPS.BLL.LadBillCancelCommentBLL.BLLLadBillCancelComment_T> GetAll()
        {
            try
            {
        ...
        public List<HPS.BLL.LadBillCancelCommentBLL.BLLLadBillCancelComment_T> GetAllBy(HPS.BLL.LadBillCancelCommentBLL.BLLLadBillCancelComment_T.LadBillCancelComment_TField fieldName, Object value)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.LadBillCancelCommentBLL.BLLLadBillCancelComment_T.LadBillCancelComment_TField fieldName, Object value, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.LadBillCancelCommentBLL.BLLLadBillCancelComment_T.LadBillCancelComment_TField fieldName, Object value, ref  System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.LadBillCancelCommentBLL.BLLLadBillCancelComment_T.LadBillCancelComment_TField fieldName, Object value, ref  System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.LadBillCancelCommentBLL.BLLLadBillCancelComment_T> GetAllByCondition(String Condition)
        {
            try
            {
        ...
        public void Delete(HPS.BLL.LadBillCancelCommentBLL.BLLLadBillCancelComment_T.LadBillCancelComment_TField fieldName, Object value)
        {
            try
            {
