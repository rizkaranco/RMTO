...
{
    public class BLLLadeCancelComment_TFactory : BusinessFactoryBase
    {
        private HPS.DAL.LadeCancelCommentDAL.DALLadeCancelComment_T _dataObject = null;

        public BLLLadeCancelComment_TFactory()
            : base("LadeCancelComment_T")
        {
            _dataObject = (HPS.DAL.LadeCancelCommentDAL.DALLadeCancelComment_T)base.DataAccessLayer;
        }
        ...
        public void GetBy(HPS.BLL.LadeCancelCommentBLL.BLLLadeCancelComment_TKeys keys, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.LadeCancelCommentBLL.BLLLadeCancelComment_TKeys keys, ref System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public List<HPS.BLL.LadeCancelCommentBLL.BLLLadeCancelComment_T> GetAll()
        {
            try
            {
        ...
        public List<HPS.BLL.LadeCancelCommentBLL.BLLLadeCancelComment_T> GetAllBy(HPS.BLL.LadeCancelCommentBLL.BLLLadeCancelComment_T.LadeCancelComment_TField fieldName, Object value)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.LadeCancelCommentBLL.BLLLadeCancelComment_T.LadeCancelComment_TField fieldName, Object value, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.LadeCancelCommentBLL.BLLLadeCancelComment_T.LadeCancelComment_TField fieldName, Object value, ref  System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.LadeCancelCommentBLL.BLLLadeCancelComment_T.LadeCancelComment_TField fieldName, Object value, ref  System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.LadeCancelCommentBLL.BLLLadeCancelComment_T> GetAllByCondition(String Condition)
        {
            try
            {
        ...
        public void Delete(HPS.BLL.LadeCancelCommentBLL.BLLLadeCancelComment_T.LadeCancelComment_TField fieldName, Object value)
        {
            try
            {
