...
{
    public class BLLLadeComment_TFactory : BusinessFactoryBase
    {
        private HPS.DAL.LadeCommentDAL.DALLadeComment_T _dataObject = null;

        public BLLLadeComment_TFactory()
            : base("LadeComment_T")
        {
            _dataObject = (HPS.DAL.LadeCommentDAL.DALLadeComment_T)base.DataAccessLayer;
        }
        ...
        public void Insert(HPS.BLL.LadeCommentBLL.BLLLadeComment_T businessObject)
        {
            try
            {
                if (businessObject.IsValid(Hepsa.Core.Validation.ValidationExceptionType.Except, "LadeCommentID_int") == false)
                {
        ...
        public void GetBy(HPS.BLL.LadeCommentBLL.BLLLadeComment_TKeys keys, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.LadeCommentBLL.BLLLadeComment_TKeys keys, ref System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.LadeCommentBLL.BLLLadeComment_T> GetAll()
        {
            try
            {
        ...
        public List<HPS.BLL.LadeCommentBLL.BLLLadeComment_T> GetAllBy(HPS.BLL.LadeCommentBLL.BLLLadeComment_T.LadeComment_TField fieldName, Object value)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.LadeCommentBLL.BLLLadeComment_T.LadeComment_TField fieldName, Object value, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.LadeCommentBLL.BLLLadeComment_T.LadeComment_TField fieldName, Object value, ref  System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.LadeCommentBLL.BLLLadeComment_T.LadeComment_TField fieldName, Object value, ref  System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.LadeCommentBLL.BLLLadeComment_T> GetAllByCondition(String Condition)
        {
            try
            {
        ...
        public void Delete(HPS.BLL.LadeCommentBLL.BLLLadeComment_T.LadeComment_TField fieldName, Object value)
        {
            try
            {
