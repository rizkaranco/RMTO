...
{
    public class BLLPermission_TFactory : BusinessFactoryBase
    {
        private HPS.DAL.PermissionDAL.DALPermission_T _dataObject = null;

        public BLLPermission_TFactory()
            : base("Permission_T")
        {
            _dataObject = (HPS.DAL.PermissionDAL.DALPermission_T)base.DataAccessLayer;
        }
        ...
        public HPS.BLL.PermissionBLL.BLLPermission_T GetBy(HPS.BLL.PermissionBLL.BLLPermission_TKeys keys)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.PermissionBLL.BLLPermission_TKeys keys, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.PermissionBLL.BLLPermission_TKeys keys, ref System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.PermissionBLL.BLLPermission_TKeys keys, ref System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.PermissionBLL.BLLPermission_T> GetAll()
        {
            try
            {
        ...
        public List<HPS.BLL.PermissionBLL.BLLPermission_T> GetAllBy(HPS.BLL.PermissionBLL.BLLPermission_T.Permission_TField fieldName, Object value)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.PermissionBLL.BLLPermission_T.Permission_TField fieldName, Object value, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.PermissionBLL.BLLPermission_T.Permission_TField fieldName, Object value, ref  System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.PermissionBLL.BLLPermission_T.Permission_TField fieldName, Object value, ref  System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.PermissionBLL.BLLPermission_T> GetAllByCondition(String Condition)
        {
            try
            {
        ...
        public void Delete(HPS.BLL.PermissionBLL.BLLPermission_TKeys keys)
        {
            try
            {
        ...
        public void Delete(HPS.BLL.PermissionBLL.BLLPermission_T.Permission_TField fieldName, Object value)
        {
            try
            {
