...
{
    public class BLLCar_TFactory : BusinessFactoryBase
    {
        private HPS.DAL.CarDAL.DALCar_T _dataObject = null;

        public BLLCar_TFactory()
            : base("Car_T")
        {
            _dataObject = (HPS.DAL.CarDAL.DALCar_T)base.DataAccessLayer;
        }
        ...
        public void Insert(HPS.BLL.CarBLL.BLLCar_T businessObject)
        {
            try
            {
                if (businessObject.IsValid(Hepsa.Core.Validation.ValidationExceptionType.Except, "CarID_int") == false)
                {
        ...
        public void GetBy(HPS.BLL.CarBLL.BLLCar_TKeys keys, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.CarBLL.BLLCar_TKeys keys, ref System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public List<HPS.BLL.CarBLL.BLLCar_T> GetAll()
        {
            try
            {
        ...
        public List<HPS.BLL.CarBLL.BLLCar_T> GetAllBy(HPS.BLL.CarBLL.BLLCar_T.Car_TField fieldName, Object value)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.CarBLL.BLLCar_T.Car_TField fieldName, Object value, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.CarBLL.BLLCar_T.Car_TField fieldName, Object value, ref  System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.CarBLL.BLLCar_T.Car_TField fieldName, Object value, ref  System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.CarBLL.BLLCar_T> GetAllByCondition(String Condition)
        {
            try
            {
        ...
        public void Delete(HPS.BLL.CarBLL.BLLCar_T.Car_TField fieldName, Object value)
        {
            try
            {
        ...
        public void CarSystemGetAll(ref System.Data.DataTable dataTable)
        {
            try
            {
                _dataObject.CarSystemSelectAll(ref dataTable);
            }
            catch (System.Exception ex)
            {
                throw Hepsa.Core.Exception.HandleException.ChangeExceptionLanguage(ex, this);
        ...
        public void GetByPlate(string PlateNumber, ref System.Data.DataTable dataTable)
        {
            try
            {
                _dataObject.SelectByPlate(PlateNumber, ref dataTable);
            }
            catch (System.Exception ex)
            {
                throw Hepsa.Core.Exception.HandleException.ChangeExceptionLanguage(ex, this);
        ...
        public void GetAllByConditionWithCardReader(String Condition, ref  System.Data.DataTable dataTable)
        {
            try
            {
                _dataObject.SelectByConditionWithCardReader(Condition.ToString(), ref dataTable);
            }
            catch (System.Exception ex)
            {
                throw Hepsa.Core.Exception.HandleException.ChangeExceptionLanguage(ex, this);
        ...
        public void DeleteTransferCarData(string SourcePath, string SourceTable)
        {
            try
            {
                _dataObject.DeleteTransferCarData(SourcePath, SourceTable);
            }
            catch (System.Exception ex)
            {
                throw Hepsa.Core.Exception.HandleException.ChangeExceptionLanguage(ex, this);
