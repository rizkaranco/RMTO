...
{
    public class BLLCompany_TFactory : BusinessFactoryBase
    {
        private HPS.DAL.CompanyDAL.DALCompany_T _dataObject = null;

        public BLLCompany_TFactory()
            : base("Company_T")
        {
            _dataObject = (HPS.DAL.CompanyDAL.DALCompany_T)base.DataAccessLayer;
        }
        ...
        public HPS.BLL.CompanyBLL.BLLCompany_T GetBy(HPS.BLL.CompanyBLL.BLLCompany_TKeys keys)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.CompanyBLL.BLLCompany_TKeys keys, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.CompanyBLL.BLLCompany_TKeys keys, ref System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.CompanyBLL.BLLCompany_TKeys keys, ref System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.CompanyBLL.BLLCompany_T> GetAll()
        {
            try
            {
        ...
        public List<HPS.BLL.CompanyBLL.BLLCompany_T> GetAllBy(HPS.BLL.CompanyBLL.BLLCompany_T.Company_TField fieldName, Object value)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.CompanyBLL.BLLCompany_T.Company_TField fieldName, Object value, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.CompanyBLL.BLLCompany_T.Company_TField fieldName, Object value, ref  System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.CompanyBLL.BLLCompany_T.Company_TField fieldName, Object value, ref  System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.CompanyBLL.BLLCompany_T> GetAllByCondition(String Condition)
        {
            try
            {
        ...
        public void Delete(HPS.BLL.CompanyBLL.BLLCompany_TKeys keys)
        {
            try
            {
        ...
        public void Delete(HPS.BLL.CompanyBLL.BLLCompany_T.Company_TField fieldName, Object value)
        {
            try
            {
