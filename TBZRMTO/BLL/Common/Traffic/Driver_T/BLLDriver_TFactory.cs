...
{
    public class BLLDriver_TFactory : BusinessFactoryBase
    {
        private HPS.DAL.DriverDAL.DALDriver_T _dataObject = null;

        public BLLDriver_TFactory()
            : base("Driver_T")
        {
            _dataObject = (HPS.DAL.DriverDAL.DALDriver_T)base.DataAccessLayer;
        }
        ...
        public void GetBy(HPS.BLL.DriverBLL.BLLDriver_TKeys keys, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.DriverBLL.BLLDriver_TKeys keys, ref System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public List<HPS.BLL.DriverBLL.BLLDriver_T> GetAll()
        {
            try
            {
        ...
        public List<HPS.BLL.DriverBLL.BLLDriver_T> GetAllBy(HPS.BLL.DriverBLL.BLLDriver_T.Driver_TField fieldName, Object value)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.DriverBLL.BLLDriver_T.Driver_TField fieldName, Object value, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.DriverBLL.BLLDriver_T.Driver_TField fieldName, Object value, ref  System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.DriverBLL.BLLDriver_T.Driver_TField fieldName, Object value, ref  System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.DriverBLL.BLLDriver_T> GetAllByCondition(String Condition)
        {
            try
            {
        ...
        public void Delete(HPS.BLL.DriverBLL.BLLDriver_T.Driver_TField fieldName, Object value)
        {
            try
            {
        ...
        //LaterAdded
        public void GetByCardNumber(string CardNumber, ref System.Data.DataTable dataTable)
        {
            try
            {
                _dataObject.SelectByCardNumber(CardNumber, ref dataTable);
            }
            catch (System.Exception ex)
            {
                throw Hepsa.Core.Exception.HandleException.ChangeExceptionLanguage(ex, this);
        ...
        public void GetAllByConditionSearch(string DriverCardNumber, string DocNumber, Int64? NationalCode, string LastName, ref  System.Data.DataTable dataTable)
        {
            try
            {
                _dataObject.SelectByConditionSearch(DriverCardNumber, DocNumber, NationalCode, LastName, ref dataTable);
            }
            catch (System.Exception ex)
            {
                throw Hepsa.Core.Exception.HandleException.ChangeExceptionLanguage(ex, this);
        ...
        public void DeleteTransferData(string SourcePath, string SourceTable)
        {
            try
            {
                _dataObject.DeleteTransferData(SourcePath, SourceTable);
            }
            catch (System.Exception ex)
            {
                throw Hepsa.Core.Exception.HandleException.ChangeExceptionLanguage(ex, this);
