...
{
    public partial class BLLSensorsStatus_TFactory : BusinessFactoryBase
    {
        private HPS.DAL.DALSensorsStatus.DALSensorsStatus_T _dataObject = null;

        public BLLSensorsStatus_TFactory()
            : base("SensorsStatus_T")
        {
            _dataObject = (HPS.DAL.DALSensorsStatus.DALSensorsStatus_T)base.DataAccessLayer;
        }
        ...
        public void Insert(HPS.BLL.BLLSensorsStatus.BLLSensorsStatus_T businessObject)
        {
            try
            {
                if (businessObject.IsValid(Hepsa.Core.Validation.ValidationExceptionType.Except, "UniquesensorsStatusID_int") == false)
                {
        ...
        public void GetBy(HPS.BLL.BLLSensorsStatus.BLLSensorsStatus_TKeys keys, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.BLLSensorsStatus.BLLSensorsStatus_TKeys keys, ref System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public List<HPS.BLL.BLLSensorsStatus.BLLSensorsStatus_T> GetAll()
        {
            try
            {
        ...
        public List<HPS.BLL.BLLSensorsStatus.BLLSensorsStatus_T> GetAllBy(HPS.BLL.BLLSensorsStatus.BLLSensorsStatus_T.SensorsStatus_TField fieldName, Object value)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.BLLSensorsStatus.BLLSensorsStatus_T.SensorsStatus_TField fieldName, Object value, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.BLLSensorsStatus.BLLSensorsStatus_T.SensorsStatus_TField fieldName, Object value, ref  System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.BLLSensorsStatus.BLLSensorsStatus_T.SensorsStatus_TField fieldName, Object value, ref  System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.BLLSensorsStatus.BLLSensorsStatus_T> GetAllByCondition(String Condition)
        {
            try
            {
        ...
        public void Delete(HPS.BLL.BLLSensorsStatus.BLLSensorsStatus_T.SensorsStatus_TField fieldName, Object value)
        {
            try
            {
