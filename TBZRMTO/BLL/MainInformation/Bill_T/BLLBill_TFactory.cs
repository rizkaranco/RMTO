...
{
    public class BLLBill_TFactory : BusinessFactoryBase
    {
        private HPS.DAL.BillDAL.DALBill_T _dataObject = null;

        public BLLBill_TFactory()
            : base("Bill_T")
        {
            _dataObject = (HPS.DAL.BillDAL.DALBill_T)base.DataAccessLayer;
        }
        ...
        public void GetBy(HPS.BLL.BillBLL.BLLBill_TKeys keys, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.BillBLL.BLLBill_TKeys keys, ref System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public List<HPS.BLL.BillBLL.BLLBill_T> GetAll()
        {
            try
            {
        ...
        public List<HPS.BLL.BillBLL.BLLBill_T> GetAllBy(HPS.BLL.BillBLL.BLLBill_T.Bill_TField fieldName, Object value)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.BillBLL.BLLBill_T.Bill_TField fieldName, Object value, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.BillBLL.BLLBill_T.Bill_TField fieldName, Object value, ref  System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.BillBLL.BLLBill_T.Bill_TField fieldName, Object value, ref  System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.BillBLL.BLLBill_T> GetAllByCondition(String Condition)
        {
            try
            {
        ...
        public void Delete(HPS.BLL.BillBLL.BLLBill_T.Bill_TField fieldName, Object value)
        {
            try
            {
