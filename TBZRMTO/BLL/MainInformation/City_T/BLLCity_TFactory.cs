...
{
    public class BLLCity_TFactory : BusinessFactoryBase
    {
        private HPS.DAL.CityDAL.DALCity_T _dataObject = null;

        public BLLCity_TFactory()
            : base("City_T")
        {
            _dataObject = (HPS.DAL.CityDAL.DALCity_T)base.DataAccessLayer;
        }
        ...
        public HPS.BLL.CityBLL.BLLCity_T GetBy(HPS.BLL.CityBLL.BLLCity_TKeys keys)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.CityBLL.BLLCity_TKeys keys, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.CityBLL.BLLCity_TKeys keys, ref System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.CityBLL.BLLCity_TKeys keys, ref System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.CityBLL.BLLCity_T> GetAll()
        {
            try
            {
        ...
        public List<HPS.BLL.CityBLL.BLLCity_T> GetAllBy(HPS.BLL.CityBLL.BLLCity_T.City_TField fieldName, Object value)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.CityBLL.BLLCity_T.City_TField fieldName, Object value, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.CityBLL.BLLCity_T.City_TField fieldName, Object value, ref  System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.CityBLL.BLLCity_T.City_TField fieldName, Object value, ref  System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.CityBLL.BLLCity_T> GetAllByCondition(String Condition)
        {
            try
            {
        ...
        public void Delete(HPS.BLL.CityBLL.BLLCity_TKeys keys)
        {
            try
            {
        ...
        public void Delete(HPS.BLL.CityBLL.BLLCity_T.City_TField fieldName, Object value)
        {
            try
            {
