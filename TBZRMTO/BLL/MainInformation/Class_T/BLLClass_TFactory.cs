...
{
public class BLLClass_TFactory: BusinessFactoryBase
    {
    private HPS.DAL.ClassDAL.DALClass_T _dataObject = null;

    public BLLClass_TFactory()
        :base("Class_T")
    {
        _dataObject = (HPS.DAL.ClassDAL.DALClass_T)base.DataAccessLayer;
    }
...
throw new Hepsa.Core.Validation.InvalidBusinessObjectException(businessObject.BrokenRulesList().ToString());
    ...
    public void GetBy( HPS.BLL.ClassBLL.BLLClass_TKeys keys , ref  System.Data.DataSet dataSet,String  srcTable  ){
        try{
    ...
    public void GetBy( HPS.BLL.ClassBLL.BLLClass_TKeys keys , ref System.Data.DataSet dataSet){
        try{
    ...
    public List< HPS.BLL.ClassBLL.BLLClass_T> GetAll()  {
        try{
    ...
    public List<HPS.BLL.ClassBLL.BLLClass_T> GetAllBy(  HPS.BLL.ClassBLL.BLLClass_T.Class_TField fieldName,Object  value  ) {
        try{
    ...
    public void GetAllBy(  HPS.BLL.ClassBLL.BLLClass_T.Class_TField fieldName, Object value  , ref  System.Data.DataSet dataSet, String srcTable  ){
        try{
    ...
    public void GetAllBy(  HPS.BLL.ClassBLL.BLLClass_T.Class_TField fieldName,Object  value  , ref  System.Data.DataSet dataSet){
        try{
    ...
    public void GetAllBy(  HPS.BLL.ClassBLL.BLLClass_T.Class_TField fieldName, Object value  , ref  System.Data.DataTable dataTable){
        try{
    ...
    public List< HPS.BLL.ClassBLL.BLLClass_T> GetAllByCondition(String Condition  ) {
        try{
    ...
    public void Delete(  HPS.BLL.ClassBLL.BLLClass_TKeys keys){
     ...
     public void Delete( HPS.BLL.ClassBLL.BLLClass_T.Class_TField fieldName ,Object  value  ){
         try
         {
