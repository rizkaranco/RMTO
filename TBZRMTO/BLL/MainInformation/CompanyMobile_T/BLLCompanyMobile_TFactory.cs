...
namespace HPS.BLL
{
public partial class BLLCompanyMobile_TFactory: BusinessFactoryBase
    {
    private HPS.DAL.DALCompanyMobile_T _dataObject = null;

    public BLLCompanyMobile_TFactory()
        :base("CompanyMobile_T")
    {
        _dataObject = (HPS.DAL.DALCompanyMobile_T)base.DataAccessLayer;
    }
...
if (businessObject.IsValid(Hepsa.Core.Validation.ValidationExceptionType.Except, ExceptList.ToArray()) == false)
{
    ...
    public void GetBy( HPS.BLL.BLLCompanyMobile_TKeys keys , ref  System.Data.DataSet dataSet,String  srcTable  )
    {
        try 
        {
    ...
    public void GetBy( HPS.BLL.BLLCompanyMobile_TKeys keys , ref System.Data.DataSet dataSet)
    {
        try
        {
    ...
    public List< HPS.BLL.BLLCompanyMobile_T> GetAll()  
    {
        try
        {
    ...
    public List<HPS.BLL.BLLCompanyMobile_T> GetAllBy(  HPS.BLL.BLLCompanyMobile_T.CompanyMobile_TField fieldName,Object  value  ) 
    {
        try 
        {
    ...
    public void GetAllBy(  HPS.BLL.BLLCompanyMobile_T.CompanyMobile_TField fieldName, Object value  , ref  System.Data.DataSet dataSet, String srcTable  )
    {
        try
        {
    ...
    public void GetAllBy(  HPS.BLL.BLLCompanyMobile_T.CompanyMobile_TField fieldName,Object  value  , ref  System.Data.DataSet dataSet)
    {
        try
        {
    ...
    public void GetAllBy(  HPS.BLL.BLLCompanyMobile_T.CompanyMobile_TField fieldName, Object value  , ref  System.Data.DataTable dataTable)
    {
        try
        {
    ...
    public List< HPS.BLL.BLLCompanyMobile_T> GetAllByCondition(String Condition  ) 
    {
        try
        {
    ...
    public void Delete(  HPS.BLL.BLLCompanyMobile_TKeys keys)
    {
     ...
     public void Delete( HPS.BLL.BLLCompanyMobile_T.CompanyMobile_TField fieldName ,Object  value  )
    {
         try
         {
