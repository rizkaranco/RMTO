...
{
public class BLLCountry_TFactory: BusinessFactoryBase
    {
    private HPS.DAL.CountryDAL.DALCountry_T _dataObject = null;

    public BLLCountry_TFactory()
        :base("Country_T")
    {
        _dataObject = (HPS.DAL.CountryDAL.DALCountry_T)base.DataAccessLayer;
    }
...
throw new Hepsa.Core.Validation.InvalidBusinessObjectException(businessObject.BrokenRulesList().ToString());
    ...
    public  HPS.BLL.CountryBLL.BLLCountry_T GetBy( HPS.BLL.CountryBLL.BLLCountry_TKeys keys ) {
        try{
    ...
    public void GetBy( HPS.BLL.CountryBLL.BLLCountry_TKeys keys , ref  System.Data.DataSet dataSet,String  srcTable  ){
        try{
    ...
    public void GetBy( HPS.BLL.CountryBLL.BLLCountry_TKeys keys , ref System.Data.DataSet dataSet){
        try{
    ...
    public void GetBy(  HPS.BLL.CountryBLL.BLLCountry_TKeys keys, ref System.Data.DataTable dataTable  ){
        try{
    ...
    public List< HPS.BLL.CountryBLL.BLLCountry_T> GetAll()  {
        try{
    ...
    public List<HPS.BLL.CountryBLL.BLLCountry_T> GetAllBy(  HPS.BLL.CountryBLL.BLLCountry_T.Country_TField fieldName,Object  value  ) {
        try{
    ...
    public void GetAllBy(  HPS.BLL.CountryBLL.BLLCountry_T.Country_TField fieldName, Object value  , ref  System.Data.DataSet dataSet, String srcTable  ){
        try{
    ...
    public void GetAllBy(  HPS.BLL.CountryBLL.BLLCountry_T.Country_TField fieldName,Object  value  , ref  System.Data.DataSet dataSet){
        try{
    ...
    public void GetAllBy(  HPS.BLL.CountryBLL.BLLCountry_T.Country_TField fieldName, Object value  , ref  System.Data.DataTable dataTable){
        try{
    ...
    public List< HPS.BLL.CountryBLL.BLLCountry_T> GetAllByCondition(String Condition  ) {
        try{
    ...
    public void Delete(  HPS.BLL.CountryBLL.BLLCountry_TKeys keys){
        try{
     ...
     public void Delete( HPS.BLL.CountryBLL.BLLCountry_T.Country_TField fieldName ,Object  value  ){
         try
         {
