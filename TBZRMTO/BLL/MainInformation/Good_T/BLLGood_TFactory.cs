...
{
    public class BLLGood_TFactory : BusinessFactoryBase
    {
        private HPS.DAL.GoodDAL.DALGood_T _dataObject = null;

        public BLLGood_TFactory()
            : base("Good_T")
        {
            _dataObject = (HPS.DAL.GoodDAL.DALGood_T)base.DataAccessLayer;
        }
        ...
        public HPS.BLL.GoodBLL.BLLGood_T GetBy(HPS.BLL.GoodBLL.BLLGood_TKeys keys)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.GoodBLL.BLLGood_TKeys keys, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.GoodBLL.BLLGood_TKeys keys, ref System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public void GetBy(HPS.BLL.GoodBLL.BLLGood_TKeys keys, ref System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.GoodBLL.BLLGood_T> GetAll()
        {
            try
            {
        ...
        public List<HPS.BLL.GoodBLL.BLLGood_T> GetAllBy(HPS.BLL.GoodBLL.BLLGood_T.Good_TField fieldName, Object value)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.GoodBLL.BLLGood_T.Good_TField fieldName, Object value, ref  System.Data.DataSet dataSet, String srcTable)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.GoodBLL.BLLGood_T.Good_TField fieldName, Object value, ref  System.Data.DataSet dataSet)
        {
            try
            {
        ...
        public void GetAllBy(HPS.BLL.GoodBLL.BLLGood_T.Good_TField fieldName, Object value, ref  System.Data.DataTable dataTable)
        {
            try
            {
        ...
        public List<HPS.BLL.GoodBLL.BLLGood_T> GetAllByCondition(String Condition)
        {
            try
            {
        ...
        public void Delete(HPS.BLL.GoodBLL.BLLGood_TKeys keys)
        {
            try
            {
        ...
        public void Delete(HPS.BLL.GoodBLL.BLLGood_T.Good_TField fieldName, Object value)
        {
            try
            {
