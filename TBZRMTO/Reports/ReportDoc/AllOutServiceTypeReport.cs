...
{
    /// <summary>
    /// Summary description for AllOutServiceTypeReport.
    /// </summary>
    public partial class AllOutServiceTypeReport : DataDynamics.ActiveReports.ActiveReport
    {

        public AllOutServiceTypeReport(string FromDate, string FromTime, string ToDate, string ToTime)
        {
            //
            ...
            try
            {
                ...
                TrafficFactory.SelectAllOutServiceTypeReport(FromDate, FromTime, ToDate, ToTime, ref LaderTypeReportTable);
