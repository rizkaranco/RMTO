...
{
    /// <summary>
    /// Summary description for CompanyRemanedLadBillWithDateReport.
    /// </summary>
    public partial class CompanyRemanedLadBillWithDateReport : DataDynamics.ActiveReports.ActiveReport
    {

        public CompanyRemanedLadBillWithDateReport(string FromDate, string FromTime, string ToDate, string ToTime, String LaderTypeID, String CompanyID, string OrderColumns_nvc,bool JustRemained, String  GoodIDlist, String DestinationCityIDList, String PortPlaceList)
        {
            //
        ...
        {
            AllRemainedPercentGrouptxt.Text=((Convert.ToDouble(AllRemainedCountGrouptxt.Text)*100)/(Convert.ToDouble(AllRequestGrouptxt.Text))).ToString("0.##");
        }

        private void groupFooter1_Format(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(AllGroupPortageFeetxt.Text) == false)
                 AllGroupPortageFeetxt.Text = string.Format("{0:#,###}", decimal.Parse(AllGroupPortageFeetxt.Text));
